...
import de.roboticbrain.foodmod.creativetab.CreativeTabFoodMod;
import de.roboticbrain.foodmod.item.ModItems;
...
public class FoodMod {
    ...
    public static CreativeTabs creativeTab = new CreativeTabFoodMod(CreativeTabs.getNextID(), Reference.MOD_ID);
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        /*
         * // Initialize mod blocks ModBlocks.init();
         */
